  ...
  return (
    ...
    <div className="flex min-h-[calc(100vh-14rem)] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <div className="absolute left-1/2 top-1/3 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute right-1/4 top-1/2 h-[300px] w-[300px] rounded-full bg-accent/10 blur-3xl" />
      </div>

      {/* 404 number */}
      <div className="relative" aria-hidden="true">
        <span className="select-none text-[10rem] font-black leading-none tracking-tighter text-muted/30 sm:text-[14rem]">
          404
        </span>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-primary text-primary-foreground shadow-xl shadow-primary/20">
            <Sprout className="h-10 w-10 text-current" />
          </div>
        </div>
      </div>
